...
public class DAOVivienda {
	...
	//----------------------------------------------------------------------------------------------------------------------------------
		...
		*/
		 ...
		 */
		public void addVivienda(PersonaOperador operador, Vivienda viv) throws SQLException, Exception {
		...
		public Vivienda convertResultSetToVivienda(ResultSet resultSet) throws SQLException {
			...
			int personaOperadorId = resultSet.getInt("COMUNIDADID");
			 ...
			 viv = new Vivienda(menaje, numeroHabitaciones,ocupada, ubicacion, viviendaId, personaOperadorId);
